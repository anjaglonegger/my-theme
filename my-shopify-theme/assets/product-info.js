  ...
  customElements.define(
    ...
    class ProductInfo extends HTMLElement {
      ...
      constructor() {
        ...
        this.zoomEnabled = this.hasAttribute('data-zoom-on-hover');
        this.thumbnailSlider = this.querySelector('.thumbnail-slider');
        this.mainImage = this.querySelector('.gallery-viewer .product__media-item');
      ...
      initializeThumbnailSlider() {
        ...
        const thumbnails = this.thumbnailSlider.querySelectorAll('.slider__slide');
        thumbnails.forEach(thumb => {
          thumb.addEventListener('click', () => {
            const targetId = thumb.getAttribute('data-target');
            const targetImage = this.querySelector(`#${targetId}`);
            if (targetImage) {
              this.mainImage.style.opacity = '0';
              setTimeout(() => {
                this.mainImage.innerHTML = targetImage.innerHTML;
      ...
      initializeZoom() {
        ...
        this.mainImage.addEventListener('mouseenter', (e) => {
